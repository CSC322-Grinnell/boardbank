...
User.create(firstname: 'User', lastname: 'man', email: 'user@exam.com', password: 'password', address: '123 Main Street', city: 'Grinnell', state: 'Iowa', zipcode: '50112', phonenumber: '12345678910', education: 'Bachelors', interest_1: 'Literacy', interest_2: 'Early Childhood')
