class DeviseCreateOrganizations < ActiveRecord::Migration[5.1]
  def migrate(direction)
    super
    # Create a default user
    Organization.create!(email: 'admin@example.com', password: 'password', password_confirmation: 'password') if direction == :up
  end
